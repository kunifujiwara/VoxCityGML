...
class VoxCityGML:
    ...
    def run(self):
        ...
        # Buffered rectangle for CityGML parsing (avoid edge artefacts)
        buffered_rect = create_rectangle(
            cfg.center_lon, cfg.center_lat,
            cfg.size_meters + 2 * cfg.buffer_meters,
        )

        # Initialize Google Earth Engine (needed for canopy / land cover sources)
        if cfg.gee_project:
        ...
        print("=" * 60)
        # Normalise citygml_path to a list for multi-directory support
        # (auto-discovers datasets in child/grandchild folders)
        ...
        if cfg.tree_citygml_path:
            print(f"  Tree CityGML:       {cfg.tree_citygml_path}")
        print("=" * 60)
        ...
        # Merge terrain into a single mesh for easier processing
        ...
        # ==============================================================
        # Step 4 – Buildings & bridges
        # ==============================================================
        print("\n[4/5] Rasterising buildings and bridges...")
        # Use the absolute DEM for converting CityGML z → height above ground
        ...
        # ============================================================== 
        # Voxelise – shared 3-D mesh voxelization (default)
        # ============================================================== 
        ...
        summarize_voxel_grid(voxel_grid)
